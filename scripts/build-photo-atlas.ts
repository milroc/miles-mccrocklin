...
async function main() {
  ...
  for (const entry of MANIFEST) {
    ...
    record.image = `media/portfolio/${entry.country_slug}.jpg`;
    ...
    record.image_tile = `media/portfolio/${entry.country_slug}-tile.jpg`;
    record.image_mid = `media/portfolio/${entry.country_slug}-mid.jpg`;
